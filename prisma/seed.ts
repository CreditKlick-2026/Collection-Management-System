...
async function main() {
  ...
  const leadColumns = [
    ...
    { key: 'dpd',                   label: 'DPD',                   order: 4,  type: 'text'   },
    { key: 'product',               label: 'Product Type',          order: 5,  type: 'text'   },
    { key: 'bank',                  label: 'Bank / Lender',         order: 6,  type: 'text'   },
    { key: 'status',                label: 'Status',                order: 7,  type: 'badge'  },
    { key: 'portfolio',             label: 'Portfolio',             order: 8,  type: 'text'   },
    { key: 'city',                  label: 'City',                  order: 9,  type: 'text'   },
    { key: 'state',                 label: 'State',                 order: 10, type: 'text'   },
    { key: 'email',                 label: 'Email',                 order: 11, type: 'text'   },
    { key: 'alt_mobile',            label: 'Alt Mobile',            order: 12, type: 'text'   },
    { key: 'address',               label: 'Address',               order: 13, type: 'text'   },
    { key: 'min_amt_due',           label: 'Min Amount Due',        order: 14, type: 'amount' },
    { key: 'principle_outstanding', label: 'Principle Outstanding', order: 15, type: 'amount' },
    { key: 'outstanding',           label: 'Total Outstanding',     order: 16, type: 'amount' },
    { key: 'pan',                   label: 'PAN Number',            order: 17, type: 'text'   },
    { key: 'bkt_2',                 label: 'Bucket',                order: 18, type: 'text'   },
    { key: 'createdAt',             label: 'Allocation Date',       order: 19, type: 'date'   },
    { key: 'assignedAgent',         label: 'Assigned Agent',        order: 20, type: 'text'   },
  ];
